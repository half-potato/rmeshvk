...
//
// Adapted for rmeshvk: added `enable subgroups;`, changed var<uniform> to
// var<storage, read> (GPU-written info struct from prepare_dispatch).
//****************************************************************************
...
@group(0) @binding(0)
var<storage, read> info : InfoStruct;
